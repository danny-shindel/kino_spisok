...
async function search(req,res) {
  ...
  if (!search) return res.render('movies/new', { title: 'искать', page: 'add', message: "MOVIE CANT BE FOUND. CHECK SPELLING", search:req.query.title});///add that movie cant be found or misspelled
  ...
  if (!movies) return res.render('movies/new', { title: 'искать', page: 'add' }); ///add that movie cant be found or misspelled
